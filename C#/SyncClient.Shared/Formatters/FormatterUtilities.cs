    ...
    static class FormatterUtilities
    {
        ...
        private static object ParseAtomString(string value, Type type)
        {
            if (FormatterConstants.DateTimeType.IsAssignableFrom(type))
                return Microsoft.Synchronization.ClientServices.XmlConverter.ToDateTime(value);
        ...
        private static object ParseJsonString(string value, Type type)
        {
            if (FormatterConstants.DateTimeType.IsAssignableFrom(type))
            {
                try
                {
                    int index1 = value.IndexOf(FormatterConstants.LeftBracketString, System.StringComparison.Ordinal) + 1;
                    int index2 = value.IndexOf(FormatterConstants.RightBracketString, System.StringComparison.Ordinal);
            ...
            if (FormatterConstants.DateTimeOffsetType.IsAssignableFrom(type))
            {
                try
                {
                    int index1 = value.IndexOf(FormatterConstants.SingleQuoteString, System.StringComparison.Ordinal) + 1;
                    int index2 = value.LastIndexOf(FormatterConstants.SingleQuoteString, System.StringComparison.Ordinal);
