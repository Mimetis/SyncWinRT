...
namespace Microsoft.Synchronization.Services.Formatters
{
    ...
    internal class JsonEntryInfoWrapper : EntryInfoWrapper
    {
        ...
        protected override void LoadEntryProperties(XElement entry)
        {
            ...
            {
                if (!keyValuePair.Name.LocalName.Equals(FormatterConstants.JsonSyncEntryMetadataElementName, StringComparison.CurrentCultureIgnoreCase) &&
                    !keyValuePair.Name.LocalName.Equals(FormatterConstants.IsDeletedElementName, StringComparison.CurrentCultureIgnoreCase))
                {
